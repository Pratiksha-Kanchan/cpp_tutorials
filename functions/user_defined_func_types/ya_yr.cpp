...
// Since, the return type of prime() is an int, 1 or 0 is returned to the main() calling function. 
//   If the number is a prime number, 1 is returned. If not, 0 is returned.
